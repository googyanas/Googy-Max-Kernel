...
MALI_STATIC_INLINE void __maliggy_osk_list_add(_maliggy_osk_list_t *new_entry, _maliggy_osk_list_t *prev, _maliggy_osk_list_t *next)
{
    next->prev = new_entry;
    new_entry->next = next;
    new_entry->prev = prev;
...
MALI_STATIC_INLINE void __maliggy_osk_list_del(_maliggy_osk_list_t *prev, _maliggy_osk_list_t *next)
{
    next->prev = prev;
    prev->next = next;
}

/** @addtogroup _maliggy_osk_list
 * @{ */
 ...
 * _maliggy_osk_list_del first, otherwise this will break the list.
 *
 * @param list the list element to initialize
 */
MALI_STATIC_INLINE void _maliggy_osk_list_init( _maliggy_osk_list_t *list )
{
    list->next = list;
    list->prev = list;
}
 ...
 * entry in this list
 */
MALI_STATIC_INLINE void _maliggy_osk_list_add( _maliggy_osk_list_t *new_entry, _maliggy_osk_list_t *list )
{
    __maliggy_osk_list_add(new_entry, list, list->next);
}
 ...
 * entry in this list
 */
MALI_STATIC_INLINE void _maliggy_osk_list_addtail( _maliggy_osk_list_t *new_entry, _maliggy_osk_list_t *list )
{
    __maliggy_osk_list_add(new_entry, list->prev, list);
}
 ...
 */
MALI_STATIC_INLINE void _maliggy_osk_list_del( _maliggy_osk_list_t *list )
{
    __maliggy_osk_list_del(list->prev, list->next);
}
 ...
 */
MALI_STATIC_INLINE void _maliggy_osk_list_delinit( _maliggy_osk_list_t *list )
{
    __maliggy_osk_list_del(list->prev, list->next);
    _maliggy_osk_list_init(list);
}
 ...
 */
MALI_STATIC_INLINE maliggy_bool _maliggy_osk_list_empty( _maliggy_osk_list_t *list )
{
 ...
 * element in the list.
 */
MALI_STATIC_INLINE void _maliggy_osk_list_move( _maliggy_osk_list_t *move_entry, _maliggy_osk_list_t *list )
{
    __maliggy_osk_list_del(move_entry->prev, move_entry->next);
    _maliggy_osk_list_add(move_entry, list);
}
 ...
 */
MALI_STATIC_INLINE void _maliggy_osk_list_move_list( _maliggy_osk_list_t *old_list, _maliggy_osk_list_t *new_list )
{
	MALI_DEBUG_ASSERT(_maliggy_osk_list_empty(new_list));
	if (!_maliggy_osk_list_empty(old_list))
	{
