 ...
 * ( \ref _maliggy_uk_subsystem_t,\ref  _maliggy_uk_functions) will uniquely identify the
 * U/K call across all groups of functions, and all functions. */
typedef enum
{
	/** Core functions */

    _MALI_UK_OPEN                    = 0, /**< _maliggy_ukk_open() */
    _MALI_UK_CLOSE,                       /**< _maliggy_ukk_close() */
    _MALI_UK_WAIT_FOR_NOTIFICATION,       /**< _maliggy_ukk_wait_for_notification() */
    _MALI_UK_GET_API_VERSION,             /**< _maliggy_ukk_get_api_version() */
    _MALI_UK_POST_NOTIFICATION,           /**< _maliggy_ukk_post_notification() */
	_MALI_UK_GET_USER_SETTING,       /**< _maliggy_ukk_get_user_setting() *//**< [out] */
	_MALI_UK_GET_USER_SETTINGS,       /**< _maliggy_ukk_get_user_settings() *//**< [out] */
	_MALI_UK_STREAM_CREATE,           /**< _maliggy_ukk_stream_create() */
	_MALI_UK_FENCE_CREATE_EMPTY,           /**< _maliggy_ukk_fence_create_empty() */
	_MALI_UK_FENCE_VALIDATE,          /**< _maliggy_ukk_fence_validate() */

	/** Memory functions */

    _MALI_UK_INIT_MEM                = 0,    /**< _maliggy_ukk_init_mem() */
    _MALI_UK_TERM_MEM,                       /**< _maliggy_ukk_term_mem() */
    _MALI_UK_GET_BIG_BLOCK,                  /**< _maliggy_ukk_get_big_block() */
    _MALI_UK_FREE_BIG_BLOCK,                 /**< _maliggy_ukk_free_big_block() */
    _MALI_UK_MAP_MEM,                        /**< _maliggy_ukk_mem_mmap() */
    _MALI_UK_UNMAP_MEM,                      /**< _maliggy_ukk_mem_munmap() */
    _MALI_UK_QUERY_MMU_PAGE_TABLE_DUMP_SIZE, /**< _maliggy_ukk_mem_get_mmu_page_table_dumpggy_size() */
    _MALI_UK_DUMP_MMU_PAGE_TABLE,            /**< _maliggy_ukk_mem_dumpggy_mmu_page_table() */
    _MALI_UK_ATTACH_DMA_BUF,                 /**< _maliggy_ukk_attach_dma_buf() */
    _MALI_UK_RELEASE_DMA_BUF,                /**< _maliggy_ukk_release_dma_buf() */
    _MALI_UK_DMA_BUF_GET_SIZE,               /**< _maliggy_ukk_dma_buf_get_size() */
    _MALI_UK_ATTACH_UMP_MEM,                 /**< _maliggy_ukk_attach_umpggy_mem() */
    _MALI_UK_RELEASE_UMP_MEM,                /**< _maliggy_ukk_release_umpggy_mem() */
    _MALI_UK_MAP_EXT_MEM,                    /**< _maliggy_uku_map_external_mem() */
    _MALI_UK_UNMAP_EXT_MEM,                  /**< _maliggy_uku_unmap_external_mem() */
    _MALI_UK_VA_TO_MALI_PA,                  /**< _maliggy_uku_va_to_maliggy_pa() */
    _MALI_UK_MEM_WRITE_SAFE,                 /**< _maliggy_uku_mem_write_safe() */
    ...
    _MALI_UK_PP_START_JOB            = _MALI_UK_START_JOB,            /**< _maliggy_ukk_pp_start_job() */
    _MALI_UK_GET_PP_NUMBER_OF_CORES  = _MALI_UK_GET_NUMBER_OF_CORES,  /**< _maliggy_ukk_get_pp_number_of_cores() */
    _MALI_UK_GET_PP_CORE_VERSION     = _MALI_UK_GET_CORE_VERSION,     /**< _maliggy_ukk_get_pp_core_version() */
    _MALI_UK_PP_DISABLE_WB,                                           /**< _maliggy_ukk_pp_job_disable_wb() */

    /** Vertex Processor Functions  */

    _MALI_UK_GP_START_JOB            = _MALI_UK_START_JOB,            /**< _maliggy_ukk_gp_start_job() */
    _MALI_UK_GET_GP_NUMBER_OF_CORES  = _MALI_UK_GET_NUMBER_OF_CORES,  /**< _maliggy_ukk_get_gp_number_of_cores() */
    _MALI_UK_GET_GP_CORE_VERSION     = _MALI_UK_GET_CORE_VERSION,     /**< _maliggy_ukk_get_gp_core_version() */
    _MALI_UK_GP_SUSPEND_RESPONSE,                                     /**< _maliggy_ukk_gp_suspend_response() */

	/** Profiling functions */

	_MALI_UK_PROFILING_START         = 0, /**< __maliggy_uku_profiling_start() */
	_MALI_UK_PROFILING_ADD_EVENT,         /**< __maliggy_uku_profiling_add_event() */
	_MALI_UK_PROFILING_STOP,              /**< __maliggy_uku_profiling_stop() */
	_MALI_UK_PROFILING_GET_EVENT,         /**< __maliggy_uku_profiling_get_event() */
	_MALI_UK_PROFILING_CLEAR,             /**< __maliggy_uku_profiling_clear() */
	_MALI_UK_PROFILING_GET_CONFIG,        /**< __maliggy_uku_profiling_get_config() */
	_MALI_UK_PROFILING_REPORT_SW_COUNTERS,/**< __maliggy_uku_profiling_report_sw_counters() */

	/** VSYNC reporting fuctions */
	_MALI_UK_VSYNC_EVENT_REPORT      = 0, /**< _maliggy_ukk_vsync_event_report() */

} _maliggy_uk_functions;

/** @brief Get the size necessary for system info
 *
 * @see _maliggy_ukk_get_system_info_size()
 */
typedef struct
{
    void *ctx;                      /**< [in,out] user-kernel context (trashed on output) */
	u32 size;                       /**< [out] size of buffer necessary to hold system information data, in bytes */
} _maliggy_uk_get_system_info_size_s;


/** @defgroup _maliggy_uk_getsysteminfo U/K Get System Info
 * @{ */
 ...
 */
typedef u32 _maliggy_core_version;
 ...
 * Job completion is reported using the _maliggy_ukk_wait_for_notification call.
 ...
 * last resort.
 *
 * @see _maliggy_mem_info
 */
typedef enum _maliggy_bus_usage
{
...
typedef enum maliggy_memory_cache_settings
{
	MALI_CACHE_STANDARD 			= 0,
	MALI_CACHE_GP_READ_ALLOCATE     = 1,
} maliggy_memory_cache_settings ;
 ...
 * _maliggy_uk_get_system_info_s arguments provided to _maliggy_ukk_get_system_info()
 *
 ...
 */
typedef struct _maliggy_mem_info
{
	u32 size;                     /**< Size of the memory bank in bytes */
	_maliggy_bus_usage flags;        /**< Capabilitiy flags of the memory */
	u32 maximum_order_supported;  /**< log2 supported size */
	u32 identifier;               /* maliggy_memory_cache_settings cache_settings; */
	struct _maliggy_mem_info * next; /**< Next List Link */
} _maliggy_mem_info;
...
/** @defgroup _maliggy_uk_gp U/K Vertex Processor
 * @{ */

/** @defgroup _maliggy_uk_gp_suspend_response_s Vertex Processor Suspend Response
 * @{ */

/** @brief Arguments for _maliggy_ukk_gp_suspend_response()
 *
 * When _maliggy_wait_for_notification() receives notification that a
 ...
 * - copy the @c cookie value from the @c _maliggy_uk_gp_job_suspended_s notification;
 ...
 * - pass in the user-kernel context @c ctx that was returned from _maliggy_ukk_open()
 *
 */
typedef enum _maliggygp_job_suspended_response_code
{
...
} _maliggygp_job_suspended_response_code;

typedef struct
{
    void *ctx;                      /**< [in,out] user-kernel context (trashed on output) */
	u32 cookie;                     /**< [in] cookie from the _maliggy_uk_gp_job_suspended_s notification */
	_maliggygp_job_suspended_response_code code; /**< [in] abort or resume response code, see \ref _maliggygp_job_suspended_response_code */
...
} _maliggy_uk_gp_suspend_response_s;

/** @} */ /* end group _maliggy_uk_gp_suspend_response_s */

/** @defgroup _maliggy_uk_gpstartjob_s Vertex Processor Start Job
 * @{ */
...
} _maliggy_uk_job_status;

#define MALIGP2_NUM_REGS_FRAME (6)

/** @brief Arguments for _maliggy_ukk_gp_start_job()
 *
 * To start a Vertex Processor job
 * - associate the request with a reference to a @c maliggy_gp_job_info by setting
 * user_job_ptr to the address of the @c maliggy_gp_job_info of the job.
 * - set @c priority to the priority of the @c maliggy_gp_job_info
 ...
 * - copy the frame registers from the @c maliggy_gp_job_info into @c frame_registers.
 ...
 * - pass in the user-kernel context @c ctx that was returned from _maliggy_ukk_open()
 *
 * When @c _maliggy_ukk_gp_start_job() returns @c _MALI_OSK_ERR_OK, status contains the
 * result of the request (see \ref _maliggy_uk_start_job_status). If the job could
 * not get started (@c _MALI_UK_START_JOB_NOT_STARTED_DO_REQUEUE) it should be
 * tried again.
 *
 * After the job has started, @c _maliggy_wait_for_notification() will be notified
 * that the job finished or got suspended. It may get suspended due to
 * resource shortage. If it finished (see _maliggy_ukk_wait_for_notification())
 * the notification will contain a @c _maliggy_uk_gp_job_finished_s result. If
 * it got suspended the notification will contain a @c _maliggy_uk_gp_job_suspended_s
 * result.
 *
 * The @c _maliggy_uk_gp_job_finished_s contains the job status (see \ref _maliggy_uk_job_status),
 ...
 * driver shutdown.
 *
 * In case the job got suspended, @c _maliggy_uk_gp_job_suspended_s contains
 * the @c user_job_ptr identifier used to start the job with, the @c reason
 * why the job stalled (see \ref _maliggygp_job_suspended_reason) and a @c cookie
 * to identify the core on which the job stalled.  This @c cookie will be needed
 * when responding to this nofication by means of _maliggy_ukk_gp_suspend_response().
 * (see _maliggy_ukk_gp_suspend_response()). The response is either to abort or
...
{
    void *ctx;                          /**< [in,out] user-kernel context (trashed on output) */
    u32 user_job_ptr;                   /**< [in] identifier for the job in user space, a @c maliggy_gp_job_info* */
...
} _maliggy_uk_gp_job_finished_s;

typedef enum _maliggygp_job_suspended_reason
{
	_MALIGP_JOB_SUSPENDED_OUT_OF_MEMORY  /**< Polygon list builder unit (PLBU) has run out of memory */
} _maliggygp_job_suspended_reason;

typedef struct
{
	u32 user_job_ptr;                    /**< [out] identifier for the job in user space */
	_maliggygp_job_suspended_reason reason; /**< [out] reason why the job stalled */
	u32 cookie;                          /**< [out] identifier for the core in kernel space on which the job stalled */
} _maliggy_uk_gp_job_suspended_s;

/** @} */ /* end group _maliggy_uk_gp */


/** @defgroup _maliggy_uk_pp U/K Fragment Processor
 * @{ */
...
/** Flag for _maliggy_uk_pp_start_job_s */
...
/** @defgroup _maliggy_uk_ppstartjob_s Fragment Processor Start Job
 * @{ */

/** @brief Arguments for _maliggy_ukk_pp_start_job()
 *
 * To start a Fragment Processor job
 * - associate the request with a reference to a maliggy_pp_job by setting
 * @c user_job_ptr to the address of the @c maliggy_pp_job of the job.
 * - set @c priority to the priority of the maliggy_pp_job
 * - specify a timeout for the job by setting @c watchdog_msecs to the number of
 * milliseconds the job is allowed to run. Specifying a value of 0 selects the
 * default timeout in use by the device driver.
 * - copy the frame registers from the @c maliggy_pp_job into @c frame_registers.
 ...
 * the source of what needs to get counted (e.g. number of vertex loader
 * cache hits). For source id values, see ARM DDI0415A, Table 3-60.
 * - pass in the user-kernel context in @c ctx that was returned from _maliggy_ukk_open()
 *
 * When _maliggy_ukk_pp_start_job() returns @c _MALI_OSK_ERR_OK, @c status contains the
 * result of the request (see \ref _maliggy_uk_start_job_status). If the job could
 * not get started (@c _MALI_UK_START_JOB_NOT_STARTED_DO_REQUEUE) it should be
 * tried again.
 *
 * After the job has started, _maliggy_wait_for_notification() will be notified
 * when the job finished. The notification will contain a
 * @c _maliggy_uk_pp_job_finished_s result. It contains the @c user_job_ptr
 * identifier used to start the job with, the job @c status (see \ref _maliggy_uk_job_status),
 * the number of milliseconds the job took to render, and values of core registers
 * when the job finished (irq status, performance counters, renderer list
 * address). A job has finished succesfully when its status is
 * @c _MALI_UK_JOB_STATUS_FINISHED. If the hardware detected a timeout while rendering
...
} _maliggy_uk_pp_start_job_s;
/** @} */ /* end group _maliggy_uk_ppstartjob_s */
...
} _maliggy_uk_pp_job_finished_s;

typedef struct
{
	u32 number_of_enabled_cores;               /**< [out] the new number of enabled cores */
} _maliggy_uk_pp_num_cores_changed_s;
...
typedef struct
{
    ...
    _maliggy_uk_pp_job_wbx_flag wbx;   /**< [in] write-back units to disable */
} _maliggy_uk_pp_disable_wb_s;
...
/** @defgroup _maliggy_uk_waitfornotification_s Wait For Notification
 * @{ */
 ...
 *
 * @see _maliggy_uk_wait_for_notification_s
 */
typedef enum
{
	/** core notifications */
...
/** @brief Enumeration of possible settings which match maliggy_setting_t in user space
 *
 *
 */
typedef enum
...
} _maliggy_uk_user_setting_t;

/* See maliggy_user_settings_db.c */
extern const char *_maliggy_uk_user_setting_descriptions[];
...
typedef struct
{
	...
	u32 value;
} _maliggy_uk_settings_changed_s;

/** @brief Arguments for _maliggy_ukk_wait_for_notification()
 *
 * On successful return from _maliggy_ukk_wait_for_notification(), the members of
 ...
 * subsystem and id fields of the maliggy_uk_notification_type in the code.type
 * member. The type member is encoded in a way to divide up the types into a
 * subsystem field, and a per-subsystem ID field. See
 * _maliggy_uk_notification_type for more information.
 *
 ...
 * _maliggy_uk_wait_for_notification() calls should be made.
 ...
 *    - The notification data is of type _maliggy_uk_pp_job_finished_s. It contains the user_job_ptr
 ...
 * taking more than watchdog_msecs (see _maliggy_ukk_pp_start_job()) to complete, the status member will
 ...
 *     - The notification data is of type _maliggy_uk_gp_job_finished_s. The notification is similar to that of
 ...
 *     - The nofication data is of type _maliggy_uk_gp_job_suspended_s. It contains the user_job_ptr
...
{
	void *ctx;                       /**< [in,out] user-kernel context (trashed on output) */
	_maliggy_uk_notification_type type; /**< [out] Type of notification available */
	union
	{
		_maliggy_uk_gp_job_suspended_s gp_job_suspended;/**< [out] Notification data for _MALI_NOTIFICATION_GP_STALLED notification type */
		_maliggy_uk_gp_job_finished_s  gp_job_finished; /**< [out] Notification data for _MALI_NOTIFICATION_GP_FINISHED notification type */
		_maliggy_uk_pp_job_finished_s  pp_job_finished; /**< [out] Notification data for _MALI_NOTIFICATION_PP_FINISHED notification type */
		_maliggy_uk_settings_changed_s setting_changed;/**< [out] Notification data for _MALI_NOTIFICAATION_SETTINGS_CHANGED notification type */
	} data;
} _maliggy_uk_wait_for_notification_s;

/** @brief Arguments for _maliggy_ukk_post_notification()
 *
...
{
    void *ctx;                       /**< [in,out] user-kernel context (trashed on output) */
	_maliggy_uk_notification_type type; /**< [in] Type of notification to post */
} _maliggy_uk_post_notification_s;

/** @} */ /* end group _maliggy_uk_waitfornotification_s */

/** @defgroup _maliggy_uk_getapiversion_s Get API Version
 * @{ */
 ...
 * change. Version 1 would be 0x00010001. Used in _maliggy_uk_get_api_version_s.
 */
typedef u32 _maliggy_uk_api_version;

/** @brief Arguments for _maliggy_uk_get_api_version()
 *
...
{
    void *ctx;                      /**< [in,out] user-kernel context (trashed on output) */
	_maliggy_uk_api_version version;   /**< [in,out] API version of user-side interface. */
	int compatible;                 /**< [out] @c 1 when @version is compatible, @c 0 otherwise */
} _maliggy_uk_get_api_version_s;
/** @} */ /* end group _maliggy_uk_getapiversion_s */

/** @defgroup _maliggy_uk_get_user_settings_s Get user space settings */
...
} _maliggy_uk_get_user_settings_s;
...
{
	void *ctx;                       /**< [in,out] user-kernel context (trashed on output) */
	_maliggy_uk_user_setting_t setting; /**< [in] setting to get */
	u32 value;                       /**< [out] value of setting */
} _maliggy_uk_get_user_setting_s;

/** @} */ /* end group _maliggy_uk_core */


/** @defgroup _maliggy_uk_memory U/K Memory
 * @{ */

/** @brief Arguments for _maliggy_ukk_init_mem(). */
typedef struct
{
    void *ctx;                      /**< [in,out] user-kernel context (trashed on output) */
	u32 maliggy_address_base;          /**< [out] start of MALI address space */
	u32 memory_size;                /**< [out] total MALI address space available */
} _maliggy_uk_init_mem_s;

/** @brief Arguments for _maliggy_ukk_term_mem(). */
typedef struct
{
    void *ctx;                      /**< [in,out] user-kernel context (trashed on output) */
} _maliggy_uk_term_mem_s;

/** Flag for _maliggy_uk_map_external_mem_s, _maliggy_uk_attach_umpggy_mem_s and _maliggy_uk_attach_dma_buf_s */
...
typedef struct
{
	...
	u32 size;                       /**< [in] size */
	u32 maliggy_address;               /**< [in] mali address to map the physical memory to */
	u32 rights;                     /**< [in] rights necessary for accessing memory */
	u32 flags;                      /**< [in] flags, see \ref _MALI_MAP_EXTERNAL_MAP_GUARD_PAGE */
	u32 cookie;                     /**< [out] identifier for mapped memory object in kernel space  */
} _maliggy_uk_map_external_mem_s;

typedef struct
{
    void *ctx;                      /**< [in,out] user-kernel context (trashed on output) */
	u32 cookie;                     /**< [out] identifier for mapped memory object in kernel space  */
} _maliggy_uk_unmap_external_mem_s;

/** @note This is identical to _maliggy_uk_map_external_mem_s above, however phys_addr is replaced by memory descriptor */
typedef struct
{
    void *ctx;                      /**< [in,out] user-kernel context (trashed on output) */
...
typedef struct
{
	...
	u32 mem_fd;                     /**< [in] Memory descriptor */
	u32 size;                       /**< [out] size */
} _maliggy_uk_dma_buf_get_size_s;

typedef struct
{
    void *ctx;                      /**< [in,out] user-kernel context (trashed on output) */
	u32 cookie;                     /**< [in] identifier for mapped memory object in kernel space  */
} _maliggy_uk_release_dma_buf_s;

/** @note This is identical to _maliggy_uk_map_external_mem_s above, however phys_addr is replaced by secure_id */
typedef struct
{
    void *ctx;                      /**< [in,out] user-kernel context (trashed on output) */
	...
	u32 flags;                      /**< [in] flags, see \ref _MALI_MAP_EXTERNAL_MAP_GUARD_PAGE */
	u32 cookie;                     /**< [out] identifier for mapped memory object in kernel space  */
} _maliggy_uk_attach_umpggy_mem_s;

typedef struct
{
    void *ctx;                      /**< [in,out] user-kernel context (trashed on output) */
	u32 cookie;                     /**< [in] identifier for mapped memory object in kernel space  */
} _maliggy_uk_release_umpggy_mem_s;

/** @brief Arguments for _maliggy_ukk_va_to_maliggy_pa()
 *
...
} _maliggy_uk_va_to_maliggy_pa_s;

/**
 * @brief Arguments for _maliggy_uk[uk]_mem_write_safe()
 */
typedef struct
{
	void *ctx;        /**< [in,out] user-kernel context (trashed on output) */
...
} _maliggy_uk_mem_write_safe_s;

typedef struct
{
    void *ctx;                      /**< [in,out] user-kernel context (trashed on output) */
	u32 size;                       /**< [out] size of MMU page table information (registers + page tables) */
} _maliggy_uk_query_mmu_page_table_dumpggy_size_s;
...
typedef struct
{
	...
	u32 page_table_dumpggy_size;       /**< [out] size of MMU page table dump */
	u32 *page_table_dump;           /**< [out] pointer within buffer where MMU page table dump is stored */
} _maliggy_uk_dumpggy_mmu_page_table_s;
...
/** @brief Arguments for _maliggy_ukk_get_pp_number_of_cores()
 *
 * - pass in the user-kernel context @c ctx that was returned from _maliggy_ukk_open()
 * - Upon successful return from _maliggy_ukk_get_pp_number_of_cores(), @c number_of_cores
...
} _maliggy_uk_get_pp_number_of_cores_s;

/** @brief Arguments for _maliggy_ukk_get_pp_core_version()
 *
 * - pass in the user-kernel context @c ctx that was returned from _maliggy_ukk_open()
 * - Upon successful return from _maliggy_ukk_get_pp_core_version(), @c version contains
 * the version that all Fragment Processor cores are compatible with.
 */
typedef struct
{
    void *ctx;                      /**< [in,out] user-kernel context (trashed on output) */
    _maliggy_core_version version;     /**< [out] version returned from core, see \ref _maliggy_core_version  */
} _maliggy_uk_get_pp_core_version_s;
...
/** @brief Arguments for _maliggy_ukk_get_gp_number_of_cores()
 *
 * - pass in the user-kernel context @c ctx that was returned from _maliggy_ukk_open()
 * - Upon successful return from _maliggy_ukk_get_gp_number_of_cores(), @c number_of_cores
...
/** @brief Arguments for _maliggy_ukk_get_gp_core_version()
 *
 * - pass in the user-kernel context @c ctx that was returned from _maliggy_ukk_open()
 * - Upon successful return from _maliggy_ukk_get_gp_core_version(), @c version contains
...
typedef struct
{
    void *ctx;                      /**< [in,out] user-kernel context (trashed on output) */
    _maliggy_core_version version;     /**< [out] version returned from core, see \ref _maliggy_core_version */
} _maliggy_uk_get_gp_core_version_s;

typedef struct
{
	void *ctx;                      /**< [in,out] user-kernel context (trashed on output) */
	u32 limit;                      /**< [in,out] The desired limit for number of events to record on input, actual limit on output */
} _maliggy_uk_profiling_start_s;

typedef struct
{
	void *ctx;                      /**< [in,out] user-kernel context (trashed on output) */
	u32 event_id;                   /**< [in] event id to register (see  enum maliggy_profiling_events for values) */
	u32 data[5];                    /**< [in] event specific data */
} _maliggy_uk_profiling_add_event_s;

typedef struct
{
	void *ctx;                      /**< [in,out] user-kernel context (trashed on output) */
	u32 count;                      /**< [out] The number of events sampled */
} _maliggy_uk_profiling_stop_s;
...
typedef struct
{
	...
	u32 event_id;                   /**< [out] event id of event (see  enum maliggy_profiling_events for values) */
	u32 data[5];                    /**< [out] event specific data */
} _maliggy_uk_profiling_get_event_s;

typedef struct
{
	void *ctx;                      /**< [in,out] user-kernel context (trashed on output) */
} _maliggy_uk_profiling_clear_s;
...
/** @brief Arguments to _maliggy_ukk_mem_mmap()
 *
 ...
 * entirely determined by _maliggy_ukk_mem_mmap(). The details of the physical pages
 ...
 * calling _maliggy_ukk_mem_munmap(). In the Mali-MMU case, the cookie is secure.
 *
 ...
 * _maliggy_ukk_get_big_block() directly calls _maliggy_ukk_mem_mmap directly, and
...
typedef struct
{
	...
	maliggy_memory_cache_settings cache_settings; /**< [in] Option to set special cache flags, tuning L2 efficency */
} _maliggy_uk_mem_mmap_s;

/** @brief Arguments to _maliggy_ukk_mem_munmap()
 *
 * The cookie and mapping members must be that returned from the same previous
 * call to _maliggy_ukk_mem_mmap(). The size member must correspond to cookie
 * and mapping - that is, it must be the value originally supplied to a call to
 * _maliggy_ukk_mem_mmap that returned the values of mapping and cookie.
 *
...
} _maliggy_uk_mem_munmap_s;
/** @} */ /* end group _maliggy_uk_memory */

/** @defgroup _maliggy_uk_vsync U/K VSYNC Wait Reporting Module
 * @{ */
 ...
 */
typedef enum _maliggy_uk_vsync_event
{
	_MALI_UK_VSYNC_EVENT_BEGIN_WAIT = 0,
	_MALI_UK_VSYNC_EVENT_END_WAIT
} _maliggy_uk_vsync_event;

/** @brief Arguments to _maliggy_ukk_vsync_event()
 *
 */
typedef struct
{
	void *ctx;                      /**< [in,out] user-kernel context (trashed on output) */
	_maliggy_uk_vsync_event event;     /**< [in] VSYNCH event type */
} _maliggy_uk_vsync_event_report_s;

/** @} */ /* end group _maliggy_uk_vsync */

/** @defgroup _maliggy_uk_sw_counters_report U/K Software Counter Reporting
 * @{ */
...
} _maliggy_uk_sw_counters_report_s;

/** @} */ /* end group _maliggy_uk_sw_counters_report */

/** @defgroup _maliggy_uk_stream U/K Mali stream module
 * @{ */
...
} _maliggy_uk_fence_create_empty_s;
...
} _maliggy_uk_fence_validate_s;

/** @} */ /* end group _maliggy_uk_stream */
