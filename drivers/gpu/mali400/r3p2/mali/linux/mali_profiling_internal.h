...
int _maliggy_internal_profiling_init(maliggy_bool auto_start);
...
int _maliggy_internal_profiling_stop(u32 * count);
int _maliggy_internal_profiling_start(u32 * limit);
