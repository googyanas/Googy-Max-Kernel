 ...
 * maliggy_pmu_power_up_all will bring the PMU back to the previous state set with
 * this function or \a maliggy_pmu_power_up.
 *
 ...
 * maliggy_pmu_power_up_all will bring the PMU back to the previous state set with
 * this function or \a maliggy_pmu_power_down.
 *
