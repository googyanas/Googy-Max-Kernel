...
/**
 * @file umpggy_kernel_descriptor_mapping.h
 */
...
typedef struct umpggy_descriptor_mapping
{
	...
	umpggy_descriptor_table * table; /**< Pointer to the current mapping table */
} umpggy_descriptor_mapping;
