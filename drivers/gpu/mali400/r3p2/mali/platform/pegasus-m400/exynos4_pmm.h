 ...
 */
typedef enum maliggy_power_mode_tag
{
	MALI_POWER_MODE_ON,
 ...
 *
 * @return _MALI_OSK_ERR_OK on success otherwise, a suitable _maliggy_osk_errcode_t error.
 */
 ...
 * for idle timer (software timer defined in maliggy_pmm_policy_jobcontrol.h) duration, MALI transitions
...
int maliggy_dvfs_bottom_lock_push(void);
